 ...
 *****************************************************************************/
#include "include/util/point_cloud_util.h"
#include <iostream>
#include <algorithm>
#include <limits>
...
bool GetPointCloudMinareaBbox(const PointFCloud& pc, BoundingCube* box,
  ...
  if (verbose) {
    std::cout << "center = " << mar.center.x << " " << mar.center.y << std::endl;
    std::cout << "size = " << mar.size.height << " " << mar.size.width << std::endl;
    std::cout << "yaw = " << mar.angle << std::endl;
    std::cout << "height = " << max_z - min_z << std::endl;
  }
  box->x = mar.center.x;
  box->y = mar.center.y;
