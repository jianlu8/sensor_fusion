...
class ProbabilisticFusionConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.perception.fusion.ProbabilisticFusionConfig) */ {
 public:
  ...
  inline ProbabilisticFusionConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  ProbabilisticFusionConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  void set_has_tracker_method();
  void clear_has_tracker_method();
  void set_has_data_association_method();
  void clear_has_data_association_method();
  void set_has_gate_keeper_method();
  void clear_has_gate_keeper_method();
  ...
  void set_has_max_cached_frame_num();
  void clear_has_max_cached_frame_num();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::std::string> prohibition_sensors_;
  static ::google::protobuf::internal::ExplicitlyConstructed< ::std::string> _default_tracker_method_;
  ::google::protobuf::internal::ArenaStringPtr tracker_method_;
  static ::google::protobuf::internal::ExplicitlyConstructed< ::std::string> _default_data_association_method_;
  ::google::protobuf::internal::ArenaStringPtr data_association_method_;
  static ::google::protobuf::internal::ExplicitlyConstructed< ::std::string> _default_gate_keeper_method_;
